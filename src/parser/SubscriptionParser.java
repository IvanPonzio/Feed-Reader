...
public class SubscriptionParser extends GeneralParser {
    ...
    public void parse() {
        ...
        try {
            FileReader reader = new FileReader("/home/ivanponzio/Escritorio/Laboraotorio2Paradigmas/grupo13_lab02_2023/config/subscriptions.json");
            ...
            for (int i = 0; i < data.length(); i++) {
                ...
                for (String urlParam : paramsList) {
                    singleSubscription.setUlrParams(urlParam); // Agrega cada parámetro utilizando el método setUlrParams
                }
